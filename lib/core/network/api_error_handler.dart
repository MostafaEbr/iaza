...
class ResponseCode {
  ...
  static const int UN_AUTHORISED = 401; // failure, user is not authorised
...
class ResponseMessage {
  ...
  static const String UN_AUTHORISED =
...
extension DataSourceExtension on DataSource {
  ApiErrorModel getFailure() {
    switch (this) {
      ...
      case DataSource.UN_AUTHORISED:
        return ApiErrorModel(
            status: ResponseCode.UN_AUTHORISED,
            message: ResponseMessage.UN_AUTHORISED);
  ...
  switch (error.type) {
    ...
    case DioExceptionType.badResponse:
      return ApiErrorModel.fromJson({
          "code":422,
          "errors":(error.response!.data as Map).containsKey("errors")?error.response!.data['errors'] :null,
        "message":(error.response!.data as Map).containsKey("message")?error.response!.data['message'] :null,
       });
    ...
    case DioExceptionType.connectionError:
      return ApiErrorModel.fromJson({
        "code":100,
        "errors":{"organization_name":"Organization name not correct"} ,
        "message":null,
      });
